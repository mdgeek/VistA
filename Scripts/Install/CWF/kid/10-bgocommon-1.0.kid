...
"RTN","AUPNSICD",2,0)
 ;;2.0;IHS PCC SUITE;**2,10**;MAY 14, 2009;Build 10
"RTN","AUPNSICD",3,0)
...
0^2^B71822067
"RTN","BGOUTL2",1,0)
BGOUTL2 ; IHS/BAO/TMD - Utilities (continued)  ;13-Jul-2015 22:12;DKM
"RTN","BGOUTL2",2,0)
...
"RTN","BGOUTL2",152,0)
 D BRDCAST^BGOUTL4("REFUSAL."_DFN_"."_TYPE,IEN_U_$$ENV^BGOUTL4("UID")_U_OPR)
"RTN","BGOUTL2",153,0)
 Q
"RTN","BGOUTL2",154,0)
...
"RTN","BGOUTL2",255,0)
 S DFN=$P(X,U,2),VIEN=$P(X,U,3),DATA=VFIEN_U_$$ENV^BGOUTL4("UID")_U_OPR_U_$P(X,U)_U_VIEN
"RTN","BGOUTL2",256,0)
...
0^4^B2406104
"RTN","BGOUTL4",1,0)
BGOUTL4 ; IHS/RI/DKM Bridge utilities;13-Jul-2015 22:12;DKM
"RTN","BGOUTL4",2,0)
