KIDS Distribution saved on Jul 15, 2015@10:44:45
PATIENT GOALS 1.0
...
"RTN","APCDGAP2",2,0)
 ;;2.0;IHS PCC SUITE;**7**;MAY 14, 2009;Build 22
"RTN","APCDGAP2",3,0)
 ;
"RTN","APCDGAP2",4,0)
 ;
...
"RTN","APCDGAPI",2,0)
 ;;2.0;IHS PCC SUITE;**7,10**;MAY 14, 2009;Build 22
"RTN","APCDGAPI",3,0)
 ;
"RTN","APCDGAPI",4,0)
 ;
...
0^1^B56721271
"RTN","BEHOPGAP",1,0)
BEHOPGAP ;IHS/MSC/MGH - PATIENT GOALS APIs;20-Jun-2015 10:57;DKM
"RTN","BEHOPGAP",2,0)
 ;;1.1;BEH COMPONENTS;**058001**;MAY 14, 2009;Build 22
"RTN","BEHOPGAP",3,0)
 ;
"RTN","BEHOPGAP",4,0)
 ;
