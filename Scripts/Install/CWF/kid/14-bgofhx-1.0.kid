...
FAMILY HISTORY 1.0
"BLD",8515,0)
FAMILY HISTORY 1.0^^0^3150713^n
"BLD",8515,4,0)
^9.64PA^9999999.27^4
...
"RTN","BGOFHLK",2,0)
 ;;1.1;BGO COMPONENTS;**6,12**;Mar 20, 2007;Build 10
"RTN","BGOFHLK",3,0)
 ;---------------------------------------------------------------
"RTN","BGOFHLK",4,0)
 ; Lookup ICD's matching input
...
"RTN","BGOFHX",2,0)
 ;;1.1;BGO COMPONENTS;**6,13**;Mar 20, 2007;Build 10
"RTN","BGOFHX",3,0)
 ;---------------------------------------------
"RTN","BGOFHX",4,0)
 ;
...
NARRATIVE^RF^^0;1^K:$L(X)>160!($L(X)<2)!'((X'?1P.E)!(X?1"|".E))!(X'?.ANP) X
