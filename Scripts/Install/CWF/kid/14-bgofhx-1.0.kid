...
y^y^f^^^^n
"BLD",8515,4,9999999.27,0)
9999999.27
"BLD",8515,4,9999999.27,222)
n^n^f^^^^n
...
"BLD",8515,4,"B",9999999.27,9999999.27)
...
"RTN","BGOFHLK",2,0)
 ;;1.1;BGO COMPONENTS;**6,12**;Mar 20, 2007;Build 9
"RTN","BGOFHLK",3,0)
 ;---------------------------------------------------------------
"RTN","BGOFHLK",4,0)
 ; Lookup ICD's matching input
...
"RTN","BGOFHX",2,0)
 ;;1.1;BGO COMPONENTS;**6,13**;Mar 20, 2007;Build 9
"RTN","BGOFHX",3,0)
 ;---------------------------------------------
"RTN","BGOFHX",4,0)
 ;
...
NARRATIVE^RF^^0;1^K:$L(X)>245!($L(X)<2)!'(X'?1P.E)!(X'?.ANP) X
...
D ^AUTNPOV
"^DD",9999999.27,9999999.27,.01,21,0)
^^4^4^2960424^^^^
"^DD",9999999.27,9999999.27,.01,21,1,0)
This is the Narrative that the provider has written out that is his
"^DD",9999999.27,9999999.27,.01,21,2,0)
description of what he treated the patient for.
"^DD",9999999.27,9999999.27,.01,21,3,0)
 
"^DD",9999999.27,9999999.27,.01,21,4,0)
...
"^DD",9999999.27,9999999.27,8801,21,0)
^^3^3^2940122^^^
"^DD",9999999.27,9999999.27,8801,21,1,0)
This is a mnemonic that stands for this provider narrative.
"^DD",9999999.27,9999999.27,8801,21,2,0)
 
"^DD",9999999.27,9999999.27,8801,21,3,0)
Enter a 1-2 character mnemonic.
"^DD",9999999.27,9999999.27,8801,21,4,0)
Enter a 1-2 character mnemonic.
...
"^DD",9999999.27,9999999.27,75701,23,0)
^^1^1^2940904^^^
"^DD",9999999.27,9999999.27,75701,23,1,0)
...
This field is used in the VA to identify what file pointing to the
"^DD",9999999.27,9999999.27,75702,21,2,0)
provider narrative file created the entry in the Provider Narrative
"^DD",9999999.27,9999999.27,75702,21,3,0)
File.  This may be useful as more packages create pointers to the
"^DD",9999999.27,9999999.27,75702,21,4,0)
Provider Narrative File to store the local capture of provider terminology.
