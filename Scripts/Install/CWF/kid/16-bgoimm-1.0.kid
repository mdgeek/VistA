KIDS Distribution saved on Oct 21, 2015@23:57:20
...
IMMUNIZATION MANAGEMENT 1.0
"BLD",8518,0)
IMMUNIZATION MANAGEMENT 1.0^^0^3151021^n
"BLD",8518,4,0)
^9.64PA^^
"BLD",8518,6.3)
7
...
BGOVIMM^^0^B186244164
"BLD",8518,"KRN",9.8,"NM",2,0)
BGOVIMM2^^0^B42331095
...
"BLD",8518,"KRN",8994,"NM","B","BGOVIMM VERSION",16)
...
0^16
"KRN",8994,2803,0)
BGOVIMM VERSION^VERSION^BGOVIMM^1
"MBREQ")
0
"ORD",16,8994)
...
0^1^B186244164
"RTN","BGOVIMM",1,0)
BGOVIMM ;IHS/BAO/TMD - IMMUNIZATION mgt   ;21-Oct-2015 16:22;DKM
"RTN","BGOVIMM",2,0)
 ;;1.1;BGO COMPONENTS;**1,3,4,5,6,9,10,11,12,13**;Mar 20, 2007;Build 7
"RTN","BGOVIMM",3,0)
 ; Returns the version # and operating mode (RPMS vs VistA) of the Immunization package
"RTN","BGOVIMM",4,0)
VERSION(RET,DUMMY) ;
"RTN","BGOVIMM",5,0)
 S RET=$$VER^BILOGO_U_$$RPMS
"RTN","BGOVIMM",6,0)
 Q
"RTN","BGOVIMM",7,0)
 ; Returns true if running as RPMS
"RTN","BGOVIMM",8,0)
RPMS() Q $$RPMS^BIUTL9()
"RTN","BGOVIMM",9,0)
...
"RTN","BGOVIMM",79,0)
 S XREF=$$VFPTXREF^BGOUTL2,FNUM=$$FNUM,OFF=$S($$RPMS:0,1:9999999)
"RTN","BGOVIMM",80,0)
...
"RTN","BGOVIMM",413,0)
 S $P(X,V,6)=$P(X0,U)
"RTN","BGOVIMM",414,0)
 S $P(X,V,7)=$S($$RPMS:$P(X0,U,6),1:$P(X0,U,22))
"RTN","BGOVIMM",415,0)
 S $P(X,V,8)=$P(X21,U)
"RTN","BGOVIMM",416,0)
 S $P(X,V,9)=$P(X0,U,7)
...
0^2^B42331095
"RTN","BGOVIMM2",1,0)
BGOVIMM2 ;IHS/BAO/TMD  BGO - IMMUNIZATION mgt;21-Oct-2015 15:44;DKM
"RTN","BGOVIMM2",2,0)
 ;;1.1;BGO COMPONENTS;**1,3,4,6,10,11,12,13**;Mar 20, 2007;Build 7
"RTN","BGOVIMM2",3,0)
 ;---------------------------------------------
"RTN","BGOVIMM2",4,0)
 ; Get case data
